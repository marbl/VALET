#!/bin/env bash
#PBS -j eo -e ${HOME}/logs/comp_w_reads_5k_${LOGNAME}.log
...
for assembler_name in MetaVelvet Velvet SOAPdenovo2 MaSuRCA;
do
    QUAST_RESULTS_DIR=${ROOT_DIR}/QUAST-w-reads-${assembler_name}/combined_reference/contigs_reports
    VALET_RESULTS_DIR=${ROOT_DIR}/mock_metamos_5k/${assembler_name}
